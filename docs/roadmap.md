...
**Status:** shipped as v0.1.0. The agent builds into a ~5 MB static binary, has end-to-end smoke coverage (HELLO + N EVENT frames), and ships with a hardened systemd unit. See [`PHASE1.md`](PHASE1.md) for the operator walkthrough.
...
- [x] `PHASE1.md` operator walkthrough
...
- [x] `PHASE2.md` operator walkthrough
