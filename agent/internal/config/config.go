// Package config loads and validates the agent TOML configuration file.
package config
...
type Config struct {
	...
	// SharedSecret is loaded from StateDir/secret at runtime and is
	// deliberately excluded from TOML parsing and serialization.
...
func Defaults() Config {
	return Config{
		...
		DryRun:   true,
		Response: Response{AllowBlockIP: true, BlockDefaultTTLSec: 3600},
		WindowsEventlog: WindowsEventlog{Mode: "pull"},
	}
}
